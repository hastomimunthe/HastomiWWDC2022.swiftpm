...
class Stage4: UIViewController {
    ...
    var buttonA: UIButton = {
        ...
        button.setTitle("A. Coordination with app unit", for: .normal)
    ...
    var buttonB: UIButton = {
        let button = UIButton()
        button.backgroundColor = .white
        button.setTitle("B. Give information to another arrival aircraft", for: .normal)
        button.titleLabel?.font = UIFont.systemFont(ofSize: 25)
        button.setTitleColor(UIColor.black, for: .normal)
    ...
    var buttonC: UIButton = {
        let button = UIButton()
        button.backgroundColor = .white
        button.setTitle("C. Give information to meteorology", for: .normal)
        button.titleLabel?.font = UIFont.systemFont(ofSize: 25)
        button.setTitleColor(UIColor.black, for: .normal)
        button.contentMode = .scaleAspectFit
        button.translatesAutoresizingMaskIntoConstraints = false
    ...
    var main2ImageView: UIImageView = {
        ...
        mainView.image = UIImage(named: "Situation4")
    ...
    @objc func actionNextPage2(_ sender: UIButton){
        navigationController?.pushViewController(Stage5(), animated: true)
        print("Clicked!")
    }
    ...
    @objc func actionRight(_ sender: UIButton){
        ...
        alert.addAction(UIAlertAction(title: "Next Question", style: .default, handler: {(action) in
            self.navigationController?.pushViewController(Stage5(), animated: true)
        }) )
